      ...
      providers = {
        ...
        dictionary = {
          ...
          opts = {
            ...
            -- have your .txt files
            dictionary_directories = { vim.fn.expand("~/.config/linkarzu/dotfiles-latest/dictionaries") },
            -- Notice I'm also adding the words I add to the spell dictionary
            dictionary_files = {
              vim.fn.expand("~/.config/linkarzu/dotfiles-latest/neovim/neobean/spell/en.utf-8.add"),
